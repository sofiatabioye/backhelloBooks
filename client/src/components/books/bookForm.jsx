        ...
        <div className="form-group">
          <div className="row">
            <div className="col s6">
              ...
              <input type="number" placeholder="ISBN" value={props.states.ISBN} onChange={props.onChange} className="validate" name="ISBN" required />
          ...
          <input type="number" placeholder="Edition" value={props.states.bookEdition} onChange={props.onChange} className="form-control" name="bookEdition" required />
          ...
          <input type="number" placeholder="Size" value={props.states.bookSize} onChange={props.onChange} className="form-control" name="bookSize" required />
